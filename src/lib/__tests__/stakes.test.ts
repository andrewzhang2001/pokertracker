...
const plo = parseHandHistories(readFileSync(resolve(root, 'hh_plo.txt'), 'utf-8'))   // OMAHA $0.10/$0.25
const nlhe = parseHandHistories(readFileSync(resolve(root, 'hh3.txt'), 'utf-8'))     // HOLDEM $0.50/$1
const mtt = parseHandHistories(readFileSync(resolve(root, 'hh.txt'), 'utf-8'))       // tournament (15/25)
